...
class LocatoresClass():
    ...
    #ProductFile
    clickLink = (By.XPATH, "//div[@id='search']/div[1]/div[1]/div/span[3]/div[2]/div[7]/div/div/div/div/div[1]/span/a/div/img")
    clickAddToCart = (By.ID, "add-to-cart-button")
    #CartBox
    click_cart_box = (By.ID, "nav-cart")
    #ProductQuantity
    qty_button = (By.ID, "a-autoid-0-announce")
    ...
    my_name = (By.XPATH, "//*[@id='home-profile-active']")
    my_name_details = (By.ID, "name-edit-modal-link")
